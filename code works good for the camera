...
def parse_detections(metadata: dict):
    ...
    # التحقق مما إذا كانت الشاحنة مكتشفة
    labels = get_labels()
    truck_detected = any(labels[int(detection.category)] == "Truck" for detection in last_detections)
    if truck_detected:
        turn_green_light()  # تشغيل الإشارة الخضراء عند اكتشاف الشاحنة
